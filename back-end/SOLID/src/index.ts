...
/*
// FUNÇÃO ANTES DA REFATORAÇÃO AQUI ESTÁ O CODIGO COM TODAS AS RESPONABILIDADES JUNTAS
...
/* FUNÇÃO DEPOIS DA REFATORAÇÃO, AQUI ESTÁ O CODIGO COM AS RESPONABILIDADES SEPARADAS, POREM AINDA DÁ PRA MELHORAR
// "Converter"
...
// Não se esqueça que é necessário exportar ao final as funções para que você possa testá-las
...
// FUNÇÃO DEPOIS DA REFATORAÇÃO, AQUI ESTÁ O CODIGO COM AS RESPONABILIDADES SEPARADAS, E MELHORADO
// ./src/index.ts
