...
console.log('A jogadora '+ player.name+' '+player.lastName+' possui '+player.medals.golden+' medalhas de ouro e '+player.medals.silver+' medalhas de prata eleita a melhor do mundo por '+player.bestInTheWorld.length+' vezes');